...
<f:view>
<h:form>
<div style="padding: 30px;font-size: 25px; margin-right: 00px; margin-left: 230px;margin-top:50 px; border: 2px solid black;width: 40%; background-color:yellow;" >
<h:outputText value="ENTER YOUR USERID"></h:outputText>
<h:inputText id="username" value="#{coronaBean.username}"></h:inputText>
<br/><br/>
<h:commandButton value="Submit" action="#{coronaBean.CheckStatus}" ></h:commandButton>
</div>
</h:form>
</f:view>	
</body>
